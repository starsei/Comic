 ...
 * 更新时间: <code style="padding: 2px 4px; font-size: 90%; color: #c7254e; background-color: #f9f2f4; border-radius: 4px;">2023-12-17</code><br/>
 * 阅读文档：<code><a href="https://github.com/starsei/Comic" target="_blank"/>README.md</code>
 * @package Comic
 * @author starsei
 * @version 1.3.0
...
{   
    ...
    public static function config(Typecho_Widget_Helper_Form $form)
    {
        ...
        $html = <<<HTML
            <ul class="typecho-option">
                <li class="title-tip" id="tip">
                    <div>
                        <p>Tips : Typecho插件,当前版本v1.3.0</p>
                        <p>阅读文档 : <a href="https://github.com/starsei/Comic" target="_blank">跳转</a></p>
                    </div>
                </li>
            </ul>
        HTML;
        ...
        _t('说明：全局css样式和全局js样式仅支持Handsome9.2.1主题使用'));
    ...
    public static function render()
    {
        ...
        echo $arr['js'];
        // 78A3F9
        echo "<script>console.log('%c Comic v1.3.0 - 二次元风格美化插件  www.starsei.com ','color:white;background-image:linear-gradient(90deg, #95B9FF 40%, #FFBBEC 97%);padding:6px;font-size:14px;border-radius:1px;text-shadow:0px 2px 2px rgba(0,0,0,.1);font-family:黑体;');// 你能留下我的信息, 我会很高兴的 ^_^</script>";
    }
            ...
            <div class="deng-box">              
                ...
                <div class="xian"></div>
                    <div class="deng-a">
                        <div class="deng-b">
                            <div class="deng-t">新春
                                <img src="./usr/themes/handsome/assets/img/red.png" id="envelope"/> 
                                <div class="tc_dl1">
