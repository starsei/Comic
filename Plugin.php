<?php
/**
 * <strong style="color:#00acff;">Comic - 二次元美化插件</strong><br/>
 * 更新时间: <code style="padding: 2px 4px; font-size: 90%; color: #c7254e; background-color: #f9f2f4; border-radius: 4px;">2023-08-17</code><br/>
<<<<<<< HEAD
 * 参考文档：<code><a href="https://alist.starsei.com/COS%E6%A1%B6/handsome/Comic" target="_blank"/>README.md</code>
=======
 * 参考文档：<code><a href="https://github.com/starsei/Comic" target="_blank"/>README.md</code>
>>>>>>> 42aef71 (first)
 * @package Comic
 * @author starsei
 * @version 1.2.0
...
{   
    ...
    public static function config(Typecho_Widget_Helper_Form $form)
    {
        ...
        $html = <<<HTML
            <ul class="typecho-option">
                <li class="title-tip" id="tip">
                    <div>
                        <p>Tips : Typecho插件,当前版本v1.2.0</p>
                        <p>阅读文档 : <a href="https://alist.starsei.com/COS%E6%A1%B6/handsome/Comic" target="_blank">跳转</a></p>
                    </div>
                </li>
            </ul>
        HTML;
        ...
        [
            'GlobalStyle'=>_t('全局样式&nbsp;&nbsp;<span style="color:#999;">默认勾选，加载<a href="/static/css/custom.css">custom.css?v=1.2.0</a></span>'),
            'GlobalJS'=>_t('全局JS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#999;">默认勾选，加载<a href="/static/js/custom.js">custom.js?v=1.2.0</a></span>'),
            'iconfont'=>_t('icon样式'),
            'live2D'=> _t('看板娘'),
        ...
        // 加载本地CSS样式 插件页面效果
        echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"{$dir}/css/plugins.css\" />";
    }
    ...
    public static function render()
    {
        ...
        echo $arr['js'];
        // 78A3F9
        echo "<script>console.log('%c Comic v1.2.0 - 二次元风格美化插件  www.starsei.com ','color:white;background-image:linear-gradient(90deg, #95B9FF 40%, #FFBBEC 97%);padding:6px;font-size:14px;border-radius:1px;text-shadow:0px 2px 2px rgba(0,0,0,.1);font-family:黑体;');// 你能留下我的信息, 我会很高兴的 ^_^</script>";
    }
